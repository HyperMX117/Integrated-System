...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="../assets/images/favicons.ico"><!-- Favicon / Icon -->
    ...
    <body>
        ...
        <header class="header">
            <a href="#" class="logo">
                <img src="../assets/images/logos.png" class="img-logo" alt="KapeTann Logo">
            </a>
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to Cafedemic Break, <?php echo $_SESSION['username']; ?>!</h3>
                <p>
                    <strong>We are open 3:00 PM to 11:00 PM.</strong>
                </p>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    <h3>Welcome to Cafedemic Break!</h3>
                    <p>
                        At Cafedemic Break, Cafedemic break offers a unique coffee house environment among others. We are not only a place to drop in and get your morning cup of coffee (although you are more welcome to do that), we are a place where you can sit down and enjoy the cafedemic break coffee. If you need to study or work we have a seating area created specifically for you. If you need to rest, we have a soft-seating area where you can relax and stress reliever. We look forward to serve you at Cafedemic Break!
                    </p>
                    <p>
                        But coffee is not just a drink, it's an experience. Our warm and
                        inviting atmosphere at Cafedemic Break is designed to be a haven
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <p>
                                    Quality Coffee at its finest!
                                </p>
                                <img src="../assets/images/pics-1.png" alt="" class="user">
                                <h3>Suyen Carillo</h3>
                                <div class="stars">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="../assets/images/quote-img.png" alt="" class="quote">
                                <p>
                                    Good ambiance, relaxing!
                                </p>
                                <img src="../assets/images/picss-2.png" alt="" class="user">
                                <h3>Mark Jimenez</h3>
                                <div class="stars">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="../assets/images/quote-img.png" alt="" class="quote">
                                <p>
                                    Lovely Coffee, I think its my favorite!
                                </p>
                                <img src="../assets/images/picss-3.png" alt="" class="user">
                                <h3>Princess Jedz Jimenez</h3>
                                <div class="stars">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
        ...
        <section class="contact" id="contact">
            ...
            <div class="row">
                ...
                <form name="contact" method="POST" action="https://formspree.io/f/mvoezvvb">
        ...
        <section class="footer">
            <div class="footer-container">
                <div class="logo">
                    <img src="../assets/images/logos.png" class="img"><br />
                    <i class="fas fa-envelope"></i>
                    <p>bcafedemic@gmail.com</p><br />
                    <i class="fas fa-phone"></i>
                    <p>+63 905-301-1548</p><br />
                    <i class="fab fa-facebook-messenger"></i>
                    <p>@Cafedemicbreak</p><br />
                </div>
                <div class="company">
                    <h2>Social Media Accounts</h2>
                    <br /> 
                    <a href="https://www.facebook.com/Cafedemic-Break-109149385133705">Facebook</a>
                    <a href="https://twitter.com/Cfdmcbrk">Twitter</a>
                    <a href="https://www.youtube.com/channel/UCtuAGJKBRM1iGEvxxo12Njw">YouTube</a>
                </div>
                ...
                <div class="credit">
                    <hr /><br/>
                    <h2>Cafedemic Break © 2024 | All Rights Reserved.</h2>
                    <h2>Designed by <span>Tnek</span> | Cafedemic Break</h2>
                </div>
            </div>
        </section>
        ...
        <script>
            ...
            center: {lat: 14.3871, lng: 120.8563}, // Updated coordinates for Bagtas, Tanza Cavite
            zoom: 15 // Adjust the zoom level as needed
    });

            var marker = new google.maps.Marker({
            position: {lat: 14.3871, lng: 120.8563}, // Updated coordinates for Bagtas, Tanza Cavite
            map: map,
            title: 'Cafedemic Break - Bagtas, Tanza Cavite' // Update the marker title as needed
    });
}
