<nav class="ts-sidebar"> <!--STUDENT SIDEBAR-->
			<ul class="ts-sidebar-menu">
				...
				{ ?>
					...
					<ul>
						<li><a href="module-menuordering/index.php">Silog Meals</a></li>
						<li><a href="Module-Coffee">Coffee Drinks</a></li>
						<!-- <li><a href="manage-rooms.php">Manage Dining</a></li> -->
					</ul>
					<li><a href="Module-Adventures"><i class="fa fa-desktop"></i>Extreme Adventure Tours</a>
					<!-- <li><a href="manage-rooms.php">Manage Dining</a></li> -->
				<?php } else { ?>
